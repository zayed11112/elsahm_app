...
class _WhyChooseUsScreenState extends State<WhyChooseUsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildFeatureImage(Feature feature, bool isDark) {
    ...
    return Expanded(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(16),
        child: Container(
          color: isDark ? Colors.black12 : feature.color.withOpacity(0.05),
          child: Center(
            child: Padding(
              padding: const EdgeInsets.all(16.0),
