...
class ImageUtils {
  ...
  static String getProxyUrl(String originalUrl) {
    // تسجيل للتشخيص
    print('تحويل رابط الصورة: $originalUrl');
    ...
    bool requiresProxy = needsProxy.any((domain) => originalUrl.contains(domain));
  ...
  static bool isValidImageUrl(String url) {
    ...
    bool hasValidProtocol = url.startsWith('http://') || url.startsWith('https://');
