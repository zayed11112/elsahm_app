...
class PropertyService {
  ...
  List<Property> _mockFeaturedProperties = [
    Property(
      ...
      location: 'حي الجامعة',
      price: 1500,
      imageUrls: ['assets/images/banners/banner1.png'],
      bedrooms: 3,
      bathrooms: 2,
      area: 120,
      isFeatured: true,
    ...
    Property(
      ...
      price: 800,
      imageUrls: ['assets/images/banners/banner2.png'],
      bedrooms: 4,
      bathrooms: 2,
      area: 150,
      isFeatured: true,
  ...
  List<Property> _mockRecentProperties = [
    Property(
      ...
      location: 'العريش',
      price: 600,
      imageUrls: ['assets/images/banners/banner3.png'],
      bedrooms: 1,
      bathrooms: 1,
      area: 50,
      isFeatured: false,
    ...
    Property(
      ...
      price: 1200,
      imageUrls: ['assets/images/banners/banner4.png'],
      bedrooms: 3,
      bathrooms: 2,
      area: 140,
      isFeatured: false,
