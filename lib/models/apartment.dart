...
class Apartment {
  static final Logger _logger = Logger('Apartment');
  ...
  factory Apartment.fromSupabase(Map<String, dynamic> data) {
    ...
    try {
      return Apartment(
        ...
        deposit:
            (data['deposit'] != null)
                ? double.tryParse(data['deposit'].toString()) ?? 0.0
                : 0.0,
        rooms:
            (data['rooms'] != null)
                ? int.tryParse(data['rooms'].toString()) ??
                    (data['bedrooms'] != null
                        ? int.tryParse(data['bedrooms'].toString()) ?? 0
                        : 0)
                : (data['bedrooms'] != null
                    ? int.tryParse(data['bedrooms'].toString()) ?? 0
                    : 0),
        ...
        isAvailable:
            data['is_available'] is bool
                ? data['is_available']
                : (data['is_available'] == 'true' || data['is_available'] == 1),
        ...
        bathrooms:
            (data['bathrooms'] != null)
                ? int.tryParse(data['bathrooms'].toString()) ??
                    ((data['beds'] != null)
                        ? int.tryParse(data['beds'].toString()) ?? 0
                        : 0)
                : ((data['beds'] != null)
                    ? int.tryParse(data['beds'].toString()) ?? 0
                    : 0),
      ...
      _logger.fine('البيانات المستلمة: $data');
