...
extension ThemeExtensions on BuildContext {
  ...
  BorderRadius get buttonRadiusBorder => BorderRadius.circular(buttonBorderRadius);
  ...
  EdgeInsets get defaultPaddingHorizontal => const EdgeInsets.symmetric(horizontal: defaultPadding);
  EdgeInsets get defaultPaddingVertical => const EdgeInsets.symmetric(vertical: defaultPadding);
